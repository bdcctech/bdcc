...
/**
  Bdcc GUI main class. This class represents the main window of the Bdcc UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BdccGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit BdccGUI(QWidget *parent = 0);
    ~BdccGUI();
