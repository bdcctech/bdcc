...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BDCC).toInt();
    ...
    fAutoRedeemBdcc = settings.value("fAutoRedeemBdcc", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBdcc: return "AutoRedeemBdcc";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BDCC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBdcc: {
            fAutoRedeemBdcc = value.toBool();
            settings.setValue("fAutoRedeemBdcc", fAutoRedeemBdcc);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBdcc() { return fAutoRedeemBdcc; }
