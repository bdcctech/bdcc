...
static const int64_t MAX_MONEY = 800000000 * COIN; //800M
...
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 20; }
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 300000; } //
inline bool IsProtocolV4(int nHeight) { return TestNet() || nHeight > 400000; } //

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 10 * 60; } // Protocol V2
inline int64_t FutureDriftV4(int64_t nTime, int nHeight) { return nTime + 20 * 60; } // Protocol V4
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return IsProtocolV4(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }
...
public:
    ...
    {
	  //return HashBlake2s(BEGIN(nVersion), END(nNonce)); //blake algo
