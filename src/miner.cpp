...
void ThreadStakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("bdccurrency-miner");
...
{
    LogPrintf("BDCCurrencyMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bdccurrency-miner");
	...
	CBlock *pblock = pblocktemplate.get();
        ...
        LogPrintf("Running BDCCurrencyMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("BDCCurrencyMiner terminated\n");
        throw;
    }
}
